...
def main():
    ...
    parser.add_argument(
        ...
        help="Biophysical parameter of the transfer function used in converting"
    ...
    parser.add_argument(
        ...
        " optimization.")
    parser.add_argument(
        '--dont-normalize', dest="normalize", default=True,
        action='store_false',
        help="Prevents ICE normalization on the counts prior to optimization."
    ...
    parser.add_argument(
        ...
        help=("Ratio of non-zero beads to be filtered out. Filtering"
              " is recommended."))
    parser.add_argument(
        "--alpha_init", type=float, default=None,
    ...
    parser.add_argument(
        "--alpha_factr", default=1e12, type=float,
    ...
    parser.add_argument(
        ...
        " constraint")
    parser.add_argument(
        "--bcc_version", type=str, default='2019',
        help="Version of the bead-chain connectivity constraint.")
    parser.add_argument(
        "--hsc_version", type=str, default='2019',
        help="For diploid organisms: version of the homolog-separating"
        " constraint.")
    parser.add_argument(
        "--counts_interchrom", type=float, default=None,
        help="For diploid organisms: mean of inter-chromosomal counts")
    parser.add_argument(
        "--est_hmlg_sep", default=None, type=float, nargs="+",
        ...
        " of mass for each chromosome. If not supplied, `est_hmlg_sep` will be"
    ...
    parser.add_argument(
        "--hsc_perc_diff", type=float, default=None,
        help="For diploid organisms: TODO")  # TODO

    # Callback
    parser.add_argument(
        "--print_freq", type=int, default=100,
        help="Frequency of iterations at which to print status during"
        " optimization.")
    parser.add_argument(
        "--log_freq", type=int, default=1000,
        help="Frequency of iterations at which to log objective value and other"
        " information during optimization.")
    parser.add_argument(
        "--save_freq", type=int, default=None,
        help="Frequency of iterations at which to save the 3D structure during"
        " optimization.")
