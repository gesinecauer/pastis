...
def _prep_for_inference(counts_raw, lengths, ploidy, outdir='', alpha=None, seed=0,
                        normalize=True, filter_threshold=0.04, alpha_init=-3.,
    ...
    """TODO
    """
    # TODO add _prep_for_inference() to main branch, maybe rename to _prep_inference()
